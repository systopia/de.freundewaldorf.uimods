...
// Make CRM_Uimods_ExtensionUtil available.
require_once __DIR__ . '/../../uimods.civix.php';

// phpcs:disable PSR1.Files.SideEffects

// Add test classes to class loader.
addExtensionDirToClassLoader(__DIR__);
addExtensionToClassLoader('de.freundewaldorf.uimods');
 ...
 */
function _uimods_test_civicrm_container(ContainerBuilder $container): void {
}
